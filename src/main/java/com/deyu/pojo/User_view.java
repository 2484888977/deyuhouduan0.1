...
//    public User_view(String username, int u_id, String password, String u_mail, String u_name, String u_sex, String u_add, int jurisdiction, int u_class, String stateCode, String info, String user_id, String address, String qq, String vx, String userinfo, String jurisdictioninfo, String stateinfo, String collegeinfo, String u_classinfo, String openid, int apartmentid, int apartmentid2) {
